...
import { useGetSingleTransactionQuery } from "@/redux/api/housekeepingApi/transactionApi";
  ...
  return (
    ...
    >
      <Link href="/super_admin/hk/trans-type">
        <UMBreadCrumb pageName="Transaction Type" lastName="View" />
      </Link>
      <div
        style={{
          padding: "20px",
            ...
            <Link href={`/super_admin/hk/trans-type`}>
              ...
              >
                <DarazCommonRedirectButton
                  to={`/super_admin/hk/trans-type/edit/${id}`}
                >
                  Go to edit
                </DarazCommonRedirectButton>
